...
class LoginTest(TestCase):
    ...
    def test_show_error_message(self):
        ...
        self.assertFormError(response, 'form', None, 'Invalid username or password')  # Adjust the error message to match what your form returns
    
    def test_submit_button(self):
        response = self.client.get(self.login_url)
        self.assertContains(response, '<input type="submit"')  # Check for the submit button in the form
